...
\begin{figure}[!ht]
  \centering
  \subfigure[]{\includegraphics[width=0.4\linewidth]{Chap3/plots/Fig3a.png}}\label{Chap:Mg_H:fig:3a}
  \subfigure[]{\includegraphics[width=0.45\linewidth]{Chap3/plots/Fig3b.png}}\label{Chap:Mg_H:fig:3b}
