...
\caption[XRD plots of FCC and HCP Ag]{XRD plots of FCC and HCP Ag. (a) XRD results of Ag with labeled peaks from  (b) Simulated XRD results for HCP Ag.}
...
\begin{figure}[!ht]
  \centering
  \subfigure[]{\includegraphics[width=0.32\linewidth]{Chap4/plots/Picture6a.pdf}}\label{Chap:Ag/ZnO:fig:6a}
  \subfigure[]{\includegraphics[width=0.32\linewidth]{Chap4/plots/Picture6b.pdf}}\label{Chap:Ag/ZnO:fig:6b}
  \subfigure[]{\includegraphics[width=0.32\linewidth]{Chap4/plots/Picture6c.pdf}}\label{Chap:Ag/ZnO:fig:6c}
...
We first investigated the results of hexagonal substrate with 3 different bond length, as shown in Fig. \ref{Chap:Ag/ZnO:fig5}. A 50$\angstrom$x50$\angstrom$ substrate is used for Ag deposition. Assuming Ag thin films all follow {111} orientation, there will be $\sim$ 50,000 Ag atoms/layer. We deposit 2,000,000 Ag atoms, which is equivalent to a 40 \ac{ML}s (10 nm thickness) of Ag atoms, then observed the morphology of thin films on different substrates. As shown in Fig. \ref{Chap:Ag/ZnO:fig5}, the left sub-figure is for 2.3$\angstrom$ bond length, the middle one for 2.9$\angstrom$, and the right one for 3.3$\angstrom$. Ag thin film follows island-like growth pattern with all three lattice constants/bond lengths. Note that the middle one, with bond length of 2.9$\angstrom$, which is similar to the situation of Ag on Ag(111) island growth pattern \cite{li2008exploration}. For ZnO lattice constant (3.3$\angstrom$), still island-like growth was observed for 10 nm thickness. Possible reasons could be: 1) a Ag chemical potential corresponding to $\sim 1 Pa$ is used, and this could be orders higher in industrial-level sputtering chamber; 2) the substrate in the simulation is perfect crystal, which does not consider the polycrystalline and surface defects. Those defect sites can have stronger bonding to Ag adsorbates, thus they may increase the chance of surface nucleation; 3) detailed surface diffusion kinetics are ignored during \ac{GCMC} simulations.

\begingroup
\begin{figure}[!ht]
  \centering
  \subfigure[]{\includegraphics[width=0.35\linewidth]{Chap4/plots/Picture7a.pdf}}\label{Chap:Ag/ZnO:fig:7a}
  \subfigure[]{\includegraphics[width=0.30\linewidth]{Chap4/plots/Picture7b.pdf}}\label{Chap:Ag/ZnO:fig:7b}
  \subfigure[]{\includegraphics[width=0.27\linewidth]{Chap4/plots/Picture7c.pdf}}\label{Chap:Ag/ZnO:fig:7c}
...
\begin{figure}[!ht]
  \centering
  \subfigure[]{\includegraphics[width=0.28\linewidth]{Chap4/plots/Picture8a.pdf}}\label{Chap:Ag/ZnO:fig:8a}
  \subfigure[]{\includegraphics[width=0.28\linewidth]{Chap4/plots/Picture8b.pdf}}\label{Chap:Ag/ZnO:fig:8b}
  \subfigure[]{\includegraphics[width=0.28\linewidth]{Chap4/plots/Picture8c.pdf}}\label{Chap:Ag/ZnO:fig:8c}
  \\
  \subfigure[]{\includegraphics[width=0.325\linewidth]{Chap4/plots/Picture8d.pdf}}\label{Chap:Ag/ZnO:fig:8d}
  \subfigure[]{\includegraphics[width=0.325\linewidth]{Chap4/plots/Picture8e.pdf}}\label{Chap:Ag/ZnO:fig:8e}
  \subfigure[]{\includegraphics[width=0.325\linewidth]{Chap4/plots/Picture8f.pdf}}\label{Chap:Ag/ZnO:fig:8f}
...
\begin{figure}[!ht]
  \centering
  \subfigure[]{\includegraphics[width=0.9\linewidth]{Chap4/plots/Picture9a.pdf}}\label{Chap:Ag/ZnO:fig:9a}
  \\
  \subfigure[]{\includegraphics[width=0.9\linewidth]{Chap4/plots/Picture9b.pdf}}\label{Chap:Ag/ZnO:fig:9b}
  \\
  \subfigure[]{\includegraphics[width=0.9\linewidth]{Chap4/plots/Picture9c.pdf}}\label{Chap:Ag/ZnO:fig:9c}
...
\begin{figure}[!ht]
  \centering
  \subfigure[]{\includegraphics[width=0.28\linewidth]{Chap4/plots/Picture10a.pdf}}\label{Chap:Ag/ZnO:fig:10a}
  \subfigure[]{\includegraphics[width=0.28\linewidth]{Chap4/plots/Picture10b.pdf}}\label{Chap:Ag/ZnO:fig:10b}
  \subfigure[]{\includegraphics[width=0.28\linewidth]{Chap4/plots/Picture10c.pdf}}\label{Chap:Ag/ZnO:fig:10c}
  \\
  \subfigure[]{\includegraphics[width=0.325\linewidth]{Chap4/plots/Picture10d.pdf}}\label{Chap:Ag/ZnO:fig:10d}
  \subfigure[]{\includegraphics[width=0.325\linewidth]{Chap4/plots/Picture10e.png}}\label{Chap:Ag/ZnO:fig:10e}
  \subfigure[]{\includegraphics[width=0.325\linewidth]{Chap4/plots/Picture10f.png}}\label{Chap:Ag/ZnO:fig:10f}
  \\
  \subfigure[]{\includegraphics[width=0.35\linewidth]{Chap4/plots/Picture10g.png}}\label{Chap:Ag/ZnO:fig:10g}
  \subfigure[]{\includegraphics[width=0.35\linewidth]{Chap4/plots/Picture10h.png}}\label{Chap:Ag/ZnO:fig:10h}
...
Next, we investigated Ag thin film morphology and qualities on rectangular-shape substrates. As shown in Fig. \ref{Chap:Ag/ZnO:fig8}, only Ag bond length substrate yields a continuous Ag thin film. Both higher and lower bond length substrates grow 3-D island Ag. Besides, From \ac{XRD} results, Ag grown on substrates with lower bond length are amorphous, which will greatly affect Ag thin film quality. Strong \ac{HCP} peaks are observed with substrate of higher bond length. In Fig. \ref{Chap:Ag/ZnO:fig:9a} and \ref{Chap:Ag/ZnO:fig:9b}, \ac{CNA} analysis is conducted for Ag thin film deposited on substrate with bond length of 2.9$\angstrom$ and 3.3$\angstrom$. The majority of the thin film is \ac{HCP} phase with small amount of vertical layered defects. Besides, centro-symmetry analysis is conducted for 3.3$\angstrom$ substrate, as shown in Fig. \ref{Chap:Ag/ZnO:fig:9c}. Vertical-oriented misfit dislocations are generated to release strain energy from lattice mismatch. Based on the above observation, Ag thin film quality on rectangular lattice substrates is sensitive to substrate lattice constant change. Similar conclusion also applys to square lattice substrates. As shown in Fig. \ref{Chap:Ag/ZnO:fig:10d}, amorphous phase comes out with decreasing lattice constant. When the substrate lattice constant increases, several nm of \ac{BCC} layers appear at the interface. 

\begingroup
\begin{figure}[!ht]
  \centering
  \subfigure[]{\includegraphics[width=0.45\linewidth]{Chap4/plots/Picture11a.png}}\label{Chap:Ag/ZnO:fig:11a}
  \subfigure[]{\includegraphics[width=0.45\linewidth]{Chap4/plots/Picture11b.png}}\label{Chap:Ag/ZnO:fig:11b}
