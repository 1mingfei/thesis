...
\begin{figure}[!ht]
  \centering
  \subfigure[]{\includegraphics[width=0.85\linewidth]{Chap5/plots/lru_evoke.eps}}\label{Chap:Al/Vac:fig:lru_calls_a}
  \subfigure[]{\includegraphics[width=0.85\linewidth]{Chap5/plots/lru_evoke_compare.eps}}\label{Chap:Al/Vac:fig:lru_calls_b}
