...
\begin{table}[!htbp]
\centering
\caption[Sensitivity analysis of different $\varepsilon_{i-X}$.]{Sensitivity analysis of different $\varepsilon_{i-X}$.}
\label{Chap:Al/Vac:tab:pseudo1}
\begin{tabular}{cccc}
\\
\hline
\hline
setup & $\varepsilon_{Al-X}$  & $\varepsilon_{Mg-X}$  & $\varepsilon_{Zn-X}$\\
\hline
1 &  0.00    &  0.00       &  0.00                 \\
2 &  0.05    &  0.00       &  0.00                 \\
3 & -0.05    &  0.00       &  0.00                 \\
